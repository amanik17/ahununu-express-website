    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      <header className="py-6 px-8 flex justify-between items-center bg-white shadow-md">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className={`absolute right-4 top-20 bg-white p-4 rounded-lg shadow-xl z-10 transition-all duration-300 transform ${showControls ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4 pointer-events-none'}`}>
